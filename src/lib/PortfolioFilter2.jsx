  ...
  return (
    <>
      ...
      <div className="items-container row" ref={isotopeContainer}>
        ...
        <ProductCard img={Product5} title="Hand Watch" price="$34.00" cats="cat-1 cat-3 cat-5" />
        <ProductCard img={Product6} title="Party Bag" price="$52.00" cats="cat-2 cat-3 cat-4" />
        <ProductCard img={Product7} title="Coffee Mug" price="$25.00" cats="cat-1 cat-2 cat-5" />
        <ProductCard img={Product8} title="Smart Watch" price="$30.00" cats="cat-1 cat-4 cat-5" />
      </div>
    </>
  );
}
