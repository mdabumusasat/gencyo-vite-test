...
import Thumb1 from '../assets/images/resource/testi1-2.jpg';
import Thumb2 from '../assets/images/resource/testi1-1.jpg';
...
import ButtonImage from '../assets/images/icons/right-arrow-1-2.png';
              ...
              <div className="bxslider">
                <div className="slider-content">
                  ...
                  <Swiper
                      ...
                      className="slider-pager">
                      <SwiperSlide className="thumb-box">
                          <img src={Details1} alt="Image" width={120}
                          height={120}/>
                      </SwiperSlide>
                      <SwiperSlide className="thumb-box">
                          <img src={Details2} alt="Image" width={120}
                          height={120}/>
                      </SwiperSlide>
                      <SwiperSlide className="thumb-box">
                          <img src={Details3} alt="Image" width={120}
                          height={120}/>
                      </SwiperSlide>
                  </Swiper>
                </div>
            ...
            <div className="col-lg-6 col-xl-6 product-info">
              ...
              <div className="product-details__buttons">
                  ...
                  <Link to="/shop-cart" className="btn-style-one">
                    <span className="btn-arrow-left"> <img src={ButtonImage} alt=""/> </span>
                    <span className="btn-title">Add to Cart</span>
                    <span className="btn-arrow-right"> <img src={ButtonImage} alt=""/> </span>
                  </Link>
    						</div>
                            ...
                            <div className="single-comment-box">
                                <div className="inner-box">
                                    ...
                                    <div className="inner">
                                        ...
                                        <h5>Jon D. William, <span>10 Mar, 2026 . 4:00 pm</span></h5>
                            ...
                            <div className="single-comment-box">
                                <div className="inner-box">
                                    ...
                                    <div className="inner">
                                        ...
                                        <h5>Aleesha Brown, <span>Mar, 2026 . 8:00 pm</span></h5>
                                        <p>Aliquam hendrerit a augue insuscipit. Etiam aliquam massa quis des mauris commodo.</p>
                                    </div>
                                </div>
                            </div>
                  ...
                  <div className="comment-box">
                    ...
                    <form id="contact_form" action="#">
                      ...
                      <div className="mb-3">
                        ...
                        <button type="submit" name='Sform' className="btn-style-one" data-loading-text="Please wait..."><span className="btn-title">Submit Comment</span></button>
                      </div>
                    </form>
                  </div> 
                </div>
