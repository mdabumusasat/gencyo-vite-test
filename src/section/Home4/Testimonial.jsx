...
const TestimonialSectionFour = () => {
  ...
  return (
    <section className="tetsimonial-section-4 position-relative">
      <div className="testimonial-light d-none d-xxl-block">
        <img src={testimonialLight} alt="light" />
      </div>
      <div
        className="testimonial-inner-4 section-padding bg-cover position-relative"
        ...
        <div className="container">
          <div className="row g-4 align-items-center">
            <div className="col-lg-5">
              <div className="testimonial-image-block4">
                <img src={testimonialImg} alt="testimonial" className="img-fluid" />
              </div>
            </div>
            <div className="col-lg-7">
              <div className="testimonial-block-four">
                  ...
                  {testimonials.map((item, index) => (
                    <SwiperSlide key={index}>
                      <div className="inner-box">
                        ...
                        <div className="clinet-info mt-3">
                ...
                <div className="array-button mt-4 d-flex gap-3">
