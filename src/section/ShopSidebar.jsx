...
import ProductImage1 from '../assets/images/resource/products/thumb-1.jpg';
import ProductImage2 from '../assets/images/resource/products/thumb-2.jpg';
import ProductImage3 from '../assets/images/resource/products/thumb-3.jpg';
          ...
          <div className="shop-sidebar">
            ...
            <div className="sidebar-widget post-widget">
              ...
              <div className="post-inner">
                <div className="post">
                <figure className="post-thumb"><Link to="/shop-product-details"><img src={ProductImage1} alt="Image" /></Link></figure>
                  <Link to="/shop-product-details">Best Headset</Link>
                  <span className="price">$45.00</span>
                </div>
                <div className="post">
                <figure className="post-thumb"><Link to="/shop-product-details"><img src={ProductImage2} alt="Image" /></Link></figure>
                  <Link to="/shop-product-details">Quality Battery</Link>
                  <span className="price">$34.00</span>
                </div>
                <div className="post">
                <figure className="post-thumb"><Link to="/shop-product-details"><img src={ProductImage3} alt="Image" /></Link></figure>
