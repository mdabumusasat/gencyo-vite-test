...
import footerVec3 from "../../assets/images/icons/footer-vec-2-1.png";
import footerLine from "../../assets/images/icons/footer-line2-1.png";
import footerBg from "../../assets/images/background/footer-lets-talk-bg.jpg";
...
const Footer = () => {
  return (
    <footer className="footer-section">
      <div className="footer-vec3 tm-gsap-animate-circle">
        <img src={footerVec3} alt="footer vector" />
      </div>
        ...
        <div className="container">
          <div
            ...
            <h2 className="title char-animation">
              Let’s Talk Schedule <br /> Consultation Today!
            </h2>
            <Link to="/page-contact" className="circle-btn wow fadeInUp" data-wow-delay=".3s">
              <img src={arrow2} alt="arrow" />
            </Link>
          </div>
          <div className="footer-widget-wrapper">
            <div className="row justify-content-between">
              <div className="col-xl-5 col-lg-6 col-md-7 wow fadeInUp" data-wow-delay=".3s">
              ...
              <div className="col-xl-2 col-sm-6 col-md-4 col-lg-3 wow fadeInUp" data-wow-delay=".5s">
                <div className="footer-widget-items mt-40">
                  <div className="widget-head mb-20">
